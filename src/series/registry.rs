...
fn seed() -> Vec<SeriesRecord> {
    vec![
        ...
        SeriesRecord {
            ...
            status: SeriesStatus::Active,
            notes: "Public calendar, standings, and session results from official site pages".into(),
        },
        SeriesRecord {
            series_key: "f3".into(),
        ...
        SeriesRecord {
            ...
            status: SeriesStatus::Active,
            notes: "Public cf.nascar.com schedule, points, and live feed".into(),
        },
        SeriesRecord {
            series_key: "indycar".into(),
            name: "INDYCAR".into(),
            discipline: Discipline::Circuit,
            provider: "indycar-wiki".into(),
            legal_tier: LegalTier::T2,
            live_enabled: false,
            free_delay_seconds: 45,
            enabled_endpoints: circuit_results_endpoints(),
            ...
            status: SeriesStatus::Active,
            notes: "Schedule and standings processed from public encyclopedic records; no proprietary live feed".into(),
        },
        SeriesRecord {
